...
def logger_checking():
    ...
    logger.debug(f"The Logger is for: {full_name.upper()}")
    ...
    try:
        ...
        logger.error("Donut Calculation Error", exc_info=True)
        logger.error("Donut Calculation Error without full info")
